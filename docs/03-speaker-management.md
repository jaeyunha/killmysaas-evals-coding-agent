...
- **SPK-03 (w2, auto):** CSV import is important at real event volumes and exercisable with the provided `speakers.csv` fixture, but the area functions without it. The fixture contains three distinct non-persona speakers (Aisha Bell, Mateo Silva, and Dana Kowalski), keeping Priya Raman unambiguously reserved for the configured speaker persona and portal tasks.
